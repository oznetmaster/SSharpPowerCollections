...
namespace Wintellect.PowerCollections
	...
	public abstract class ReadOnlyCollectionBase<T> : ICollection<T>, ICollection
		...
		public virtual void CopyTo (T[] array, int arrayIndex)
			...
			if (count < 0)
				throw new ArgumentOutOfRangeExceptionEx ("count", count, Strings.ArgMustNotBeNegative);
			if (arrayIndex < 0)
				throw new ArgumentOutOfRangeExceptionEx ("arrayIndex", arrayIndex, Strings.ArgMustNotBeNegative);
		...
		void ICollection.CopyTo (Array array, int index)
			...
			if (count < 0)
				throw new ArgumentOutOfRangeExceptionEx ("count", count, Strings.ArgMustNotBeNegative);
			if (index < 0)
				throw new ArgumentOutOfRangeExceptionEx ("index", index, Strings.ArgMustNotBeNegative);
